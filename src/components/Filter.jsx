      ...
      <div className="overlay filter-section" style={{ display: isClosed }}>
        ...
        <div className="popular-filters">
          <ul>
            ...
            <li>
              <input type="checkbox" value="Pool" name="hotelpreference" /> Pool
            </li>
            <li>
              <input type="checkbox" value="WiFi" name="hotelpreference" /> WiFi
            </li>
          </ul>
        </div>
        ...
        <div className="quest-rating-filter">
          <ul>
            ...
            <li>
              <input type="checkbox" value="Very Good" name="Very Good" /> Very
              Good
            </li>
            <li>
